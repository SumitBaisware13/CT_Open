...
st.set_page_config(page_title="CT Open Cases Dashboard", layout="wide", page_icon="⚡")
st.title("⚡ CT Open Event Analytics Dashboard")

# --- Read data ---
df = pd.read_excel("CT_OPEN_ALL_april_25.xlsx")
